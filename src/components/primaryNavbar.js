                        ...
                        <div className="faqs-part">
                          ...
                          <Accordion>
                            <Accordion.Item eventKey="0">
                              ...
                              <Accordion.Body>
                                The DOP mainnet is the live, production-ready version of the Data Ownership Protocol, which allows users to encrypt, send, and decrypt transactions on the Ethereum blockchain. It enables selective transparency, giving users control over their financial data and transactions. <br />
                                That said, <span style={{ fontWeight: "bold" }}>it is still in Beta version</span>, featuring only the core features of the Data Ownership Protocol. More features will be added over time.
                              </Accordion.Body>
                            </Accordion.Item>
                            <Accordion.Item eventKey="1">
                              <Accordion.Header>
                                {" "}
                                <span>02.</span> What are the key features of the DOP mainnet?
                              </Accordion.Header>
                              <Accordion.Body>
                                The DOP mainnet offers several key features: <br />
                                <ul>
                                  <li>Secure encryption and decryption of assets using zero-knowledge proofs</li>
                                  <li>Ability to selectively disclose holdings, transactions, and activity</li>
                                  <li>Seamless integration with existing Ethereum wallets</li>
                                  <li>Collaboration with Chainalysis to screen transactions and prevent illicit funds</li>
                                </ul>
                              </Accordion.Body>
                            </Accordion.Item>
                            <Accordion.Item eventKey="2">
                              <Accordion.Header>
                                {" "}
                                <span>03.</span> What are the benefits of using the DOP mainnet?
                              </Accordion.Header>
                              <Accordion.Body>
                                The DOP mainnet provides benefits for both individual users and businesses: <br />
                                <ul>
                                  <li>For individuals, it enables privacy and control over personal data and financial transactions, allowing for confidential crypto payments and DeFi exploration.</li>
                                  <li>For businesses, it offers secure and efficient solutions to protect competitive edges, integrate with existing systems, and avoid risks from tainted funds.</li>
                                </ul>
                              </Accordion.Body>
                            </Accordion.Item>
                            <Accordion.Item eventKey="3">
                              ...
                              <Accordion.Body>
                                The DOP mainnet uses unique "smart bouncers" and zero-knowledge proofs to enable selective transparency on the Ethereum blockchain. Users can encrypt their assets, send them to other DOP wallets, and decrypt them as needed, maintaining control over their financial data.
                              </Accordion.Body>
                            </Accordion.Item>
                            <Accordion.Item eventKey="4">
                              <Accordion.Header>
                                {" "}
                                <span>05.</span> How can users participate in the Mainnet Airdrop Campaign?
                              </Accordion.Header>
                              <Accordion.Body>
                                Users can participate in the Mainnet Airdrop Campaign by engaging in various activities on the DOP mainnet, such as encrypting assets, decrypting assets, sending transactions, referring others, and staking DOP tokens (once available). For the full details, read our <a href="https://dop.org/blog/earn-dop-tokens-with-our-mainnet-reward-campaign" target="_blank">blog post</a>.
                              </Accordion.Body>
                            </Accordion.Item>
                            <Accordion.Item eventKey="5">
                              <Accordion.Header>
                                {" "}
                                <span>06.</span>What are the rewards for participating in the Mainnet Airdrop Campaign?
                              </Accordion.Header>
                              <Accordion.Body>
                                The Mainnet Airdrop Campaign rewards users based on a points system. Users can earn points for actions like encryption, decryption, sending, referrals, and staking. These points will be used to determine the amount of DOP tokens users receive as rewards.
                              </Accordion.Body>
                            </Accordion.Item>
                            <Accordion.Item eventKey="6">
                              <Accordion.Header>
                                {" "}
                                <span>07.</span> What is the purpose of the DOP Mainnet Airdrop Campaign?
                              </Accordion.Header>
                              <Accordion.Body>
                                The primary purpose of the DOP Mainnet Airdrop Campaign is to promote the usage of the DOP mainnet, increase the protocol's total value locked (TVL), and incentivize staking of the DOP token once it becomes available.
                              </Accordion.Body>
                            </Accordion.Item>
                            <Accordion.Item eventKey="7">
                              <Accordion.Header>
                                {" "}
                                <span>08.</span> How many DOP tokens are allocated for the Mainnet Airdrop Campaign?
                              </Accordion.Header>
                              <Accordion.Body>
                                The Mainnet Airdrop Campaign is divided into two phases: V1 and V2. A total of 460,000,000 DOP tokens have been allocated for the campaign, with 230,000,000 DOP tokens dedicated to the first phase (V1), which is currently ongoing.
                              </Accordion.Body>
                            </Accordion.Item>
                            <Accordion.Item eventKey="8">
                              <Accordion.Header>
                                {" "}
                                <span>09.</span> What actions are rewarded in the V1 campaign?
                              </Accordion.Header>
                              <Accordion.Body>
                                In the V1 campaign, users can earn rewards for the following actions: encrypting assets, decrypting assets, completing achievements (badges), and staking DOP tokens (once available).
                              </Accordion.Body>
                            </Accordion.Item>
                            <Accordion.Item eventKey="9">
                              <Accordion.Header>
                                {" "}
                                <span>10.</span> How is the points system structured for the V1 campaign?
                              </Accordion.Header>
                              <Accordion.Body>
                                The points system in the V1 campaign works as follows: <br />
                                Encryption: 1 point per $1 worth of assets encrypted (with a 0.1% fee) <br />
                                Decryption: 0.5 points per $1 worth of assets decrypted (with a 0.1% fee) <br />
                                Sending: 20 points per sending action <br />
                                Referrals: 10% bonus on referral points, 100 points bonus for referred user after first encryption <br />
                                Badges: Social (+300 points), Encrypt (+300 points per 10k), Sends (+300 points per 50 sends) <br />
                                Staking: 0.05 points per 1 DOP staked per 24 hours, 10% bonus for every 30 days of staking (once available)
                            ...
                            <Accordion.Item eventKey="10">
                              ...
                              <Accordion.Body>
                                There is a fee of 0.1% for every encryption and decryption action. At a later stage, an additional fee of 10 DOP will be applied to each transaction. Since DOP currently operates on Ethereum, all transactions will also incur the usual Ethereum network gas fees. <br />
                                It’s important to note that in the not-so-distant future DOP will be integrated into various EVMs, so the network gas fees will vary accordingly, and will be significantly lower than Ethereum’s.
                            ...
                            <Accordion.Item eventKey="11">
                              <Accordion.Header>
                                {" "}
                                <span>12.</span> How are the fees generated from the DOP mainnet used?
                              </Accordion.Header>
                              <Accordion.Body>
                                The fees generated from the DOP mainnet are used for two purposes: 75% of the fees go towards the buy-back-burn of DOP tokens, while the remaining 25% are used for staking incentives.
                              </Accordion.Body>
                            </Accordion.Item>
                            <Accordion.Item eventKey="12">
                              <Accordion.Header>
                                {" "}
                                <span>13.</span> When will the V2 campaign of the Mainnet Airdrop start?
                              </Accordion.Header>
                              <Accordion.Body>
                                The details of the V2 campaign, including its start date, are currently unknown. The V2 campaign will be launched during phase 2 of the DOP project's development.
                              </Accordion.Body>
                            </Accordion.Item>
                            <Accordion.Item eventKey="13">
                              <Accordion.Header>
                                {" "}
                                <span>14.</span> How does the DOP mainnet ensure the security of encrypted assets?
                              </Accordion.Header>
                              <Accordion.Body>
                                The DOP mainnet uses zero-knowledge proofs and "smart bouncers" to securely store and transfer encrypted assets on the Ethereum blockchain. This ensures the integrity and privacy of user transactions and holdings.
                              </Accordion.Body>
                            </Accordion.Item>
                            <Accordion.Item eventKey="14">
                              <Accordion.Header>
                                {" "}
                                <span>15.</span> What is the role of the DOP token in the ecosystem?
                              </Accordion.Header>
                              <Accordion.Body>
                                The DOP token is the native utility token of the DOP ecosystem. It is used to facilitate private transactions, incentivize network participation, and enable staking rewards.
                              </Accordion.Body>
                            </Accordion.Item>
                            <Accordion.Item eventKey="15">
                              <Accordion.Header>
                                {" "}
                                <span>16.</span> How does the DOP mainnet align with the project's vision of data ownership and privacy?
                              </Accordion.Header>
                              <Accordion.Body>
                                The DOP mainnet is a crucial first step in the project's long-term vision of bringing data ownership and privacy to the Ethereum ecosystem. Future phases of the project will focus on expanding the platform's capabilities in this area.
                              </Accordion.Body>
                            </Accordion.Item>
                            <Accordion.Item eventKey="16">
                              <Accordion.Header>
                                {" "}
                                <span>17.</span> What happens to the DOP tokens that are not claimed at the end of the Mainnet Airdrop Campaign?
                              </Accordion.Header>
                              <Accordion.Body>
                                Any DOP tokens that are not claimed at the end of the Mainnet Airdrop Campaign will be used to benefit the community. This could include future airdrops, community incentives, or other initiatives designed to enhance the DOP ecosystem, or even burning the tokens to positively impact the total supply and scarcity of the token, ultimately benefiting the token's value.
                              </Accordion.Body>
                            </Accordion.Item>
                            <Accordion.Item eventKey="17">
                              <Accordion.Header>
                                {" "}
                                <span>18.</span> How will the DOP tokens allocated for the Mainnet Airdrop Campaign impact the overall token supply and distribution?
                              </Accordion.Header>
                              <Accordion.Body>
                                The Mainnet Airdrop Campaign will be divided into two phases to prevent a massive release of tokens all at once. Although these tokens are considered released and in circulation, they will only reach users gradually over several months, following the completion of the first campaign. It is important to note that this campaign will not affect the total supply of DOP tokens.
                              </Accordion.Body>
                            </Accordion.Item>
                            <Accordion.Item eventKey="18">
                              <Accordion.Header>
                                {" "}
                                <span>19.</span> Will any verification be required to claim the rewards when the campaign ends?
                              </Accordion.Header>
                              <Accordion.Body>
                                To claim rewards from the Mainnet Airdrop Campaign, users might be required to go through a proof-of-humanity process to verify their identity and prevent bots or fake accounts from participating.
                              </Accordion.Body>
                            </Accordion.Item>
                            <Accordion.Item eventKey="19">
                              ...
                              <Accordion.Body>
                                We place a high priority on security and have invested significantly in ensuring the safety of the DOP mainnet and protocol. With the launch of the mainnet, we will continue to employ additional tools to further strengthen security. We have made extensive efforts to secure the protocol, including a comprehensive security audit by Hacken, which awarded us an impressive Security Score of 10/10, Code Quality Score of 10/10, and an Overall Score of 9.7/10.  <br />
                                Our team includes security experts who contribute to the proper architecture and ongoing security measures. Additionally, we plan to conduct future bug bounty campaigns to continuously enhance our security posture.
